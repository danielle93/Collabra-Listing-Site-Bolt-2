...
$(function () {
	$(document).scroll(function () {
      ...
      var $navbrand = $(".nav-item");
	  $navbrand.toggleClass('scrolled-c', $(this).scrollTop() > $nav.height());

      var $navbrand = $(".nav-item#featured");
	  $navbrand.toggleClass('scrolled-d', $(this).scrollTop() > $nav.height());
